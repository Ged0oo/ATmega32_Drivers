...
Std_ReturnType lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8 command){
    ...
    if(NULL == lcd){
    	...
    	*/
        ...
        ret = gpio_write_logic(&(lcd->lcd_rs), GPIO_LOW);
...
Std_ReturnType lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8 data){
    ...
    if(NULL == lcd){
        ...
        ret = gpio_write_logic(&(lcd->lcd_rs), GPIO_HIGH);
...
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8 command){
    ...
    if(NULL == lcd){
        ...
        for(l_pin_counter=0; l_pin_counter<8; ++l_pin_counter){
            ret = gpio_write_logic(&(lcd->lcd_data[l_pin_counter]), (command >> l_pin_counter) & (uint8)0x01);
        }
        /* Send the Enable Signal on the "E" Pin */
...
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data){
    ...
    if(NULL == lcd){
        ...
        for(l_pin_counter=0; l_pin_counter<8; ++l_pin_counter){
            ret = gpio_write_logic(&(lcd->lcd_data[l_pin_counter]), (data >> l_pin_counter) & (uint8)0x01);
        }
        /* Send the Enable Signal on the "E" Pin */
        ret = lcd_8bit_send_enable_signal(lcd);
    }
...
{
    Std_ReturnType ret = E_OK;
    ret = gpio_write_logic(&(lcd->lcd_data[0]), (_data_command >> 0) & (uint8)0x01);
    ret = gpio_write_logic(&(lcd->lcd_data[1]), (_data_command >> 1) & (uint8)0x01);
    ret = gpio_write_logic(&(lcd->lcd_data[2]), (_data_command >> 2) & (uint8)0x01);
    ret = gpio_write_logic(&(lcd->lcd_data[3]), (_data_command >> 3) & (uint8)0x01);
...
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = E_OK;
    ret = gpio_write_logic(&(lcd->lcd_en), GPIO_HIGH);
    _delay_us(5);
    ret = gpio_write_logic(&(lcd->lcd_en), GPIO_LOW);
    return ret;
}
